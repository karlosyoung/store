        ...
        <TouchableOpacity onPress={this.feedbackTwo.bind(this,item.noticeId)}>
            <View style={styles.adList}>
                <View style={styles.adListIn}>
                    <View style={styles.adTitle}><Text numberOfLines={1} style={styles.adTitles}>{item.titleName}</Text></View>
               <View style={styles.article}><Text numberOfLines={2} style={styles.articles}>{this._formateNoticeContent(item.noticeContent)}</Text></View>
                </View>
                <View style={styles.lookBack}><Text style={styles.lookBacks}>查看订购反馈</Text></View>
            </View>
        </TouchableOpacity>
        );
    },
