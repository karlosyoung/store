            ...
            <View style={styles.backBad}>
                ...
                <View style={styles.popIn}>
                        <View style={styles.yiXin}>
                           <Image source={require('../../img/retailDetail/bigT.jpg')} resizeMode='contain' style={[styles.imgTig,{width:Util.size.width-180,height:150,marginTop:15,marginLeft:40,marginRight:40}]} />
                       ...
                       <View style={styles.centerS}><Text style={styles.jinZi}>请选择支付方式</Text></View>
                       ...
                       </View>
                       {
                            this.state.isPayBtn?
                                <TouchableOpacity onPress={this._sureBtn.bind(this)}>
                                   <Image source={require('../../img/order/sure_btn.png')}style={[styles.imgGood,{width:Util.size.width-180,height:35}]} resizeMode='contain'/>
                              </TouchableOpacity>
                           :
                              <Image source={require('../../img/order/sure_btn.png')}style={[styles.imgGood,{width:Util.size.width-180,height:35}]} resizeMode='contain'/>
                       }
                    ...
                    <TouchableOpacity onPress={this._payTypeOnPress.bind(this,item.payCode,item.payName)}>
                        {
                            ...
                            <View style={styles.yiHan}>
                                <Image source={require('../../img/retailDetail/roundo.png')} resizeMode='contain' style={[styles.fanxuan,{width:16}]} />
                                <LoadImg style={styles.zhiFu} data={
                                    {
                                        width:Util.size.width/2-85,
                                        height:40,
                            ...
                            :
                            <View style={styles.yiHan}>
                                <Image source={require('../../img/retailDetail/roundok.png')} resizeMode='contain' style={[styles.fanxuan,{width:16}]} />
                                <LoadImg data={
                                    {
                                        width:Util.size.width/2-85,
                                        height:40,
