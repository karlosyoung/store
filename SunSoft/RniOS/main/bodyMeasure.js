                            ...
                            <View style={styles.bigView}>
                                <View  style={styles.cont}>
                                    ...
                                    <View style={styles.ceLang}>
                                        <Text allowFontScaling={false} style={styles.fontG}>1.身高：赤脚站立时头顶到地面的高度</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>2.体重：保持身体平稳站在体重秤上测量</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>3.肩宽：左肩点到右肩点</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>4.胸围：经胸点处水平测量一周</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>5.腰围：经肚脐点处处水平测量一周</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>6.臀围：经臀部最丰满处水平测量一周</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>7.袖长：肩点到虎口</Text>
                                        <Text allowFontScaling={false} style={styles.fontG}>8.裤长：赤脚站立时自然腰位直至地面</Text>
                                    </View>
                                </View>
                            </View>
                    </ScrollView>
