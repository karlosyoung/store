...
var LeftRowItem = React.createClass({
    render: function() {
        return(
            <TouchableOpacity  onPress={this._loadPage.bind(this,1)}>
                <View style={styles.leftContainer}>
                    <Image defaultSource={require('../../img/common/defaultReDetail.png')} source={{uri: this.props.data.item.goodsImg+'!m324x324.jpg'}} style={[styles.thumbnail,{borderRadius:6}]} resizeMode='contain' />
                    <View style={{ position:'absolute',top:4,left:5,width:30,height:30,justifyContent:'flex-start',alignItems:'flex-start' }}>
                    {
               ...
               <View style={styles.goodTitle}><Text numberOfLines={1} allowFontScaling={false} style={styles.title}>{this.props.data.item.goodsName}</Text></View>
                    <Image source={require('../../img/retail/diline.png')} resizeMode='contain' style={styles.widthL} />
                    <View style={styles.allTitle}><Text allowFontScaling={false} style={styles.year}>智园价：</Text><Text allowFontScaling={false} numberOfLines={1} style={styles.redText}>{Util.FuncRmbFormat(this.props.data.item.shopPrice)}</Text></View>
                </View>
            </TouchableOpacity>
        );
    },
