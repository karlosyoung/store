...
var RetailDetail =React.createClass({
    ...
    render: function() {
      if (this.state==null || !this.state.loaded) {
        ...
        return (
            <View style={{flex:1}}>
            {
                                    ...
                                    <View style={styles.bigView}>
                                        ...
                                        <View style={styles.topImage}>
                                            <View  style={styles.viewImages}>
                                                <Image source={{uri: this.state.goods.goodsImg+'!m730x750.jpg'}} resizeMode='contain' style={{width:Util.size.width,height:Util.size.width*75/73}} />
                                                ...
                                                <View style={[styles.goodsTop,{position: 'absolute',bottom: 0,left: 0}]}><Text allowFontScaling={false} numberOfLines={1} style={[styles.titleName,styles.writeColor]}>{this.state.goods.goodsName}</Text><Text allowFontScaling={false} style={[styles.price,styles.redColor]}>{Util.FuncRmbFormat(this.state.goods.shopPrice)}</Text></View>
                                            </View>
                                            {
                                                this.state.goods.status!='02'?
                                                    <View style={[styles.xiaJ,{position:'absolute',top:0,left:0,width:Util.size.width,height:Util.size.width*75/73}]}>
                                                        ...
                                                        <Text allowFontScaling={false} style={ {fontSize:28,color:'#fff',textAlign:'center'} }>已下架</Text>
                                                    </View>
                                                :
                                                null
                                            }
                                            ...
                                            <View style={styles.selSize}>
                                                {
                                                    this.state.goods.status!='02'|| this.state.goods.isBuy=='no'?
                                                        <View style={styles.sizeXia}>
                                                            ...
                                                            <Text allowFontScaling={false} style={[styles.writeColor,styles.fontLu]}>选择尺码</Text>
                                                        </View>
                                                    :
                                                    ...
                                                    this.state.selectSize!=null&&this.state.selectSize!=''?
                                                        <TouchableOpacity onPress={this._checkedSize.bind(this)}>
                                                            <View style={{flex:1, flexDirection:'row', marginLeft:40,width:120}}>
                                                                <View style={styles.currentSum}><Text allowFontScaling={false} style={styles.writeColor}>{this.state.goodsNumber}件</Text></View>
                <View style={styles.currentSize}><Text allowFontScaling={false} style={[styles.writeColor,{width:60,height:30,lineHeight:22,textAlign:'center'}]}>{this.state.selectSize}</Text></View>
                                                            </View>
                                                        </TouchableOpacity>
                                                    :
                                                        this.state.goods.status!='02'|| this.state.goods.isBuy=='no'?
                                                            <View style={styles.unCheckedize}><Text allowFontScaling={false} style={[styles.writeColor,{height:30}]}></Text></View>
                                                        :
                                                            <TouchableOpacity onPress={this._checkedSize.bind(this)}>
                                                                <View style={styles.unCheckedize}><Text allowFontScaling={false} style={[styles.writeColor,{height:30}]}></Text></View>
                                                            </TouchableOpacity>
                                                }
                                                <View style={styles.rightList}></View>
                                            </View>
                                        </View>
                                                    ...
                                                    <View>
                                                        <View style={styles.goodText}>
                                                           <TouchableOpacity onPress={this._goDetail.bind(this,'good')}>
                                                               <View style={styles.goodDetail}><Text allowFontScaling={false} style={[styles.fontSi,styles.heiColor]}>商品详情</Text></View>
                                                           </TouchableOpacity>
                                                           <TouchableOpacity onPress={this._goDetail.bind(this,'supplier')}>
                                                               <View style={styles.mInfo}><Text allowFontScaling={false} style={[styles.fontSi,styles.heiColor]}>厂家信息</Text></View>
                                                           </TouchableOpacity>
                                                        </View>
                                            ...
                                            <TouchableOpacity onPress={this.FuncFetchData.bind(this,{
                                                ...
                                                fetchParamData:''
                                                       ...
                                                       <View style={styles.addsIn}>
                                                            ...
                                                            <Text style={styles.graCfont} allowFontScaling={false} >加入购物车</Text>
                                                       </View>
                                                       </View>
                                                   </TouchableOpacity>
                                                   ...
                                                   <TouchableOpacity onPress={this.onLine.bind(this)}>
                                                      <View style={styles.adds}>
                                                          ...
                                                          <Text style={styles.graCfont} allowFontScaling={false}>在线客服</Text>
                                                      </View>
                                                  </TouchableOpacity>
                                                   <TouchableOpacity onPress={this.buyGoodBtn.bind(this)}>
                                                       <View style={styles.buy}><Text allowFontScaling={false} style={{fontSize:18,color:'#fff'}}>立即购买</Text></View>
                                                   </TouchableOpacity>
                                               </View>
                                       :
                                           <View style={styles.addCar}>
                ...
                <Text style={styles.graCfont} allowFontScaling={false}>加入购物车</Text>
                                               ...
                                               <TouchableOpacity onPress={this.onLine.bind(this)}>
                                                   <View style={styles.adds}>
                                                        <Image source={require('../../img/retailDetail/c.png')} resizeMode='contain' style={[styles.imgGood,{width:Util.size.width/3}]} />
                                                        <Text style={styles.graCfont} allowFontScaling={false}>在线客服</Text>
                                                   </View>
                                               </TouchableOpacity>
                                               <View style={styles.xiaBuy}><Text allowFontScaling={false} style={{fontSize:18,color:'#fff'}}>立即购买</Text></View>
                                           </View>
                                   }
       ...
       _fetchSizeData:function() {
             var _q='?token='+this.state.token+'&goodsTypeId='+this.state.goods.goodsTypeId+'&catId='+this.state.goods.catId+'&goodsId='+this.state.goodsId+'&sex='+this.state.goods.goodsProperties;
    ...
    //在线客服
        onLine:function(){
            RNBridgeModule.onlineClick('onLine');
        },
         //获取零售特体尺码列表
