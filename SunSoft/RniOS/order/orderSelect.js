                    ...
                    <View style={{width:Util.size.width,height:55,paddingTop:10, paddingBottom:10,flex:1,flexDirection:'row', paddingLeft:14,paddingRight:14, backgroundColor:'#fff',position:'absolute',top:0,left:0}}>
                        {
                             _orderSelect=='allOrder'?
                                <TouchableOpacity onPress={this._closeBtn.bind(this,'allOrder')}>
                                    <View style={styles.redBorder}><Text allowFontScaling={false} style={styles.orderList}>全部</Text></View>
                                </TouchableOpacity>
                             :
                                <TouchableOpacity onPress={this._closeBtn.bind(this,'allOrder')}>
                                    <View style={styles.border}><Text allowFontScaling={false} style={styles.orderGray}>全部</Text></View>
                                </TouchableOpacity>
                        }
                        {
                             _orderSelect=='schoolOrder'?
                                <TouchableOpacity onPress={this._closeBtn.bind(this,'schoolOrder')}>
                                    <View style={styles.redBorder}><Text allowFontScaling={false} style={styles.orderList}>统购订单</Text></View>
                                </TouchableOpacity>
                             :
                             <TouchableOpacity onPress={this._closeBtn.bind(this,'schoolOrder')}>
                                <View style={styles.border}><Text allowFontScaling={false} style={styles.orderGray}>统购订单</Text></View>
                             </TouchableOpacity>
                        }
                        {
                             _orderSelect=='retailOrder'?
                             <TouchableOpacity onPress={this._closeBtn.bind(this,'retailOrder')}>
                                <View style={styles.redBorder}><Text allowFontScaling={false} style={styles.orderList}>零售订单</Text></View>
                             </TouchableOpacity>
                             :
                      <TouchableOpacity onPress={this._closeBtn.bind(this,'retailOrder')}>
                                <View style={styles.border}><Text allowFontScaling={false} style={styles.orderGray}>零售订单</Text></View>
                             </TouchableOpacity>
                        }
                        {
                             _orderSelect=='insteadOrder'?
                             <TouchableOpacity onPress={this._closeBtn.bind(this,'insteadOrder')}>
                                <View style={styles.redBorder}><Text allowFontScaling={false} style={styles.orderList}>代买订单</Text></View>
                             </TouchableOpacity>
                             :
                             <TouchableOpacity onPress={this._closeBtn.bind(this,'insteadOrder')}>
                                <View style={styles.border}><Text allowFontScaling={false} style={styles.orderGray}>代买订单</Text></View>
                             </TouchableOpacity>
                        }
                   </View>
            </View>
